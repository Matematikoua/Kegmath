        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-justify text-lg text-[var(--text-secondary)] mb-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-justify text-[var(--text-secondary)]">Egresado del programa de Matemáticas de la Universidad del Atlántico en Barranquilla, Colombia.  He realizado mis estudios de posgrado en México. Soy Magister en Ciencias Matemáticas del Instituto de Física y Matemáticas (IFM) de la Universidad Michoacana de San Nicolás de Hidalgo y del Centro de Ciencias Matemáticas (CCM) de la Universidad Nacional Autónoma de México (UNAM),    Doctor en Ciencias  en  la especialidad de Matemáticas del Centro de Investigación y de Estudios Avanzados del Instituto Politécnico Nacional (CINVESTAV-IPN).	</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-justify text-[var(--text-secondary)]">Debido a mi formación matemática las áreas de mi interés son las C*-álgebras, álgebra y teoría de operadores de Toeplitz, Frames y Wavelets. Las investigaciones que he realizado se han enfocado en la descripción explicita de ciertas C*-álgebras conmutativas generadas por  operadores de  Toeplitz y en la descripción del comportamiento de los Frames (marcos)  en espacios con métrica indefinida. 
</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-justify text-[var(--text-secondary)]">He trabajado como docente en diferentes instituciones de educación superior tales como la Universidad Nacional de Colombia, sede Manizales, Universidad Pedagógica y Tecnológica de Colombia (UPTC) y  Universidad de Sucre,  en todas ellas impartiendo cursos de matemáticas a nivel de pregrado y posgrado. Mi enfoque pedagógico se centra en la claridad conceptual y el desarrollo del pensamiento crítico en mis estudiantes. Actualmente soy docente tiempo completo en la Universidad de Caldas en Manizales, Colombia.</p>
                  </div>
                </div>
              </div>
            </div>
